...
<div class="col-md-12">
  ...
  <br>
  <input type="text" class="form-control" name="title" placeholder="Text input" value="<?php echo set_value('title'); ?>">
  <br>
        ...
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body pad">
                ...
                <textarea name="subject"   style="width: 100%; height: 200px;
                  font-size: 14px;
                  line-height: 18px;
                  border: 1px solid #dddddd; padding: 10px;" ><?php echo set_value('subject'); ?></textarea>
